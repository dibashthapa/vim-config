...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-treesitter', 'neoscroll.nvim', 'lspsaga.nvim', 'nvim-cmp', 'nvim-lsp-installer', 'FixCursorHold.nvim', 'null-ls.nvim', 'gitsigns.nvim', 'Comment.nvim', 'nvim-lspconfig'}, { event = "BufRead *" }, _G.packer_plugins)]]
