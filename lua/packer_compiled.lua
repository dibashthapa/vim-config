...
_G.packer_plugins = {
  ...
  ["nvim-web-devicons"] = {
    ...
    loaded = true,
    only_config = true,
    path = "/Users/dibashthapa/.local/share/nvim/site/pack/packer/start/nvim-web-devicons",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-lspconfig', 'Comment.nvim', 'lspsaga.nvim', 'nvim-cmp', 'nvim-lsp-installer', 'FixCursorHold.nvim', 'nvim-treesitter', 'neoscroll.nvim', 'gitsigns.nvim', 'null-ls.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
